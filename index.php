        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <p>
              <a href="post.php?id=<?php echo $id; ?>" class="btn btn-danger">Readmore</a>  
              </p>
                </div>
                <div class="col-md-4">
                <img src="assets/images/<?php echo $image; ?>" alt="news" class="img-thumbnail">
            </div>
            <!-- news end -->
            <?php 
            }
